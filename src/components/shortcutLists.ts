...
export const cursorShortcut = [
    ...
    { "key": "down",                  "command": "workbench.action.interactivePlayground.down",
...
export const gitShortcuts = [
        ...
        { "key": "git checkout -b [name]", "command": "create and switch to a new branch" },
        { "key": "git merge [branch]", "command": "merge another branch into current branch" },
        { "key": "git rebase [branch]", "command": "reapply commits on top of another base branch" },
        ...
        { "key": "git cherry-pick [commit]", "command": "apply a commit from another branch" },
        { "key": "git stash branch [branch]", "command": "create a branch from stashed changes" },
        { "key": "git checkout -- [file]", "command": "discard changes in working directory" },
        ...
        { "key": "git rebase --continue", "command": "continue after resolving conflicts" },
        { "key": "git rebase -i [commit]", "command": "interactive rebase from commit" },
        { "key": "git merge --no-ff [branch]", "command": "create a merge commit even if fast-forwarding" },
    
        // Remotes
        { "key": "git remote -v", "command": "show remote repositories" },
        { "key": "git remote add [name] [url]", "command": "add a new remote repository" },
        { "key": "git remote remove [name]", "command": "remove a remote repository" },
        { "key": "git push [remote] [branch]", "command": "push changes to a specific remote branch" },
        { "key": "git pull [remote] [branch]", "command": "pull changes from a specific remote branch" },
        { "key": "git fetch [remote]", "command": "fetch changes from a specific remote repository" },
        ...
        { "key": "git log --since=[date]", "command": "filter commits since a specific date" },
        { "key": "git log --until=[date]", "command": "filter commits until a specific date" },
        { "key": "git show [commit]", "command": "show details of a specific commit" },
    
        // Undo / Change History
        { "key": "git reset [commit]", "command": "reset current branch to a specific commit" },
        { "key": "git reset --hard [commit]", "command": "reset to a specific commit and discard changes" },
        { "key": "git checkout -- [file]", "command": "discard changes in a file" },
        { "key": "git revert [commit]", "command": "create a new commit that undoes changes" },
        ...
        { "key": "git tag -a [name] -m '[message]'", "command": "create an annotated tag" },
        ...
        { "key": "git stash save '[message]'", "command": "stash changes with a message" },
    ...
    export const windowsShortcuts = [
        ...
        { "key": "Ctrl + Arrow Keys", "command": "Navigate to the edge of the data region" },
        ...
        { "key": "Windows + Shift + S", "command": "Take a screenshot of a selected area" },
        ...
        { "key": "Arrow Keys", "command": "Move the cursor one character/line at a time" },
        ...
        // Selection
        { "key": "Shift + Arrow Keys", "command": "Extend the selection by one character/line" },
        { "key": "Ctrl + A", "command": "Select all content" },
        { "key": "Ctrl + Shift + Arrow Keys", "command": "Select a word or line" },
        { "key": "Shift + Space", "command": "Select the entire row" },
        { "key": "Ctrl + Space", "command": "Select the entire column" },
        { "key": "Ctrl + Shift + L", "command": "Toggle filters" },
        { "key": "Ctrl + Shift + 8", "command": "Select all cells with similar formatting" },
        ...
        // Extend Selection
        { "key": "Ctrl + Shift + End", "command": "Select from current cell to the last used cell" },
        { "key": "Ctrl + Shift + Home", "command": "Select from current cell to the first cell" },
        { "key": "Ctrl + Shift + Page Up", "command": "Select from current cell to the previous worksheet" },
        { "key": "Ctrl + Shift + Page Down", "command": "Select from current cell to the next worksheet" },
        { "key": "Shift + Click", "command": "Select a range of cells" },
        { "key": "Ctrl + A", "command": "Select all cells in the worksheet" },
        { "key": "Ctrl + Shift + Arrow Keys", "command": "Extend selection to the next data region" },
        { "key": "Shift + Space", "command": "Select the entire row" },
        { "key": "Ctrl + Space", "command": "Select the entire column" },
