export const cursorShortcut = [
    ...
    { "key": "shift+cmd+j",           "command": "aiSettings.action.openhidden",
    ...
    { "key": "cmd+p",                 "command": "expandLineSelection",
                                         "when": "textInputFocus" },
    ...
    { "key": "shift+f7",              "command": "editor.action.accessibleDiffViewer.prev",
                                         "when": "isInDiffEditor" },
    { "key": "cmd+r cmd+c",           "command": "editor.action.addCommentLine",
    ...
    { "key": "cmd+r cmd+f",           "command": "editor.action.formatSelection",
    ...
    { "key": "shift+f8",              "command": "editor.action.marker.prevInFiles",
                                         "when": "editorFocus" },
    { "key": "alt+cmd+f8",            "command": "editor.action.marker.this",
                                         "when": "editorFocus" },
    { "key": "alt+down",              "command": "editor.action.moveLinesDownAction",
                                         "when": "editorTextFocus && !editorReadonly" },
    { "key": "alt+up",                "command": "editor.action.moveLinesUpAction",
                                         "when": "editorTextFocus && !editorReadonly" },
    { "key": "cmd+r cmd+d",           "command": "editor.action.moveSelectionToNextFindMatch",
                                         "when": "editorFocus" },
    { "key": "alt+f9",                "command": "editor.action.nextCommentThreadAction" },
    { "key": "cmd+r alt+cmd+down",    "command": "editor.action.nextCommentingRange",
    ...
    { "key": "cmd+r alt+cmd+up",      "command": "editor.action.previousCommentingRange",
                                         "when": "accessibilityModeEnabled && commentFocused || accessibilityModeEnabled && editorFocus || accessibilityHelpIsShown && accessibilityModeEnabled && accessibleViewCurrentProviderId == 'comments'" },
    ...
    { "key": "alt+cmd+backspace",     "command": "editor.action.removeBrackets",
                                         "when": "editorTextFocus" },
    { "key": "cmd+r cmd+u",           "command": "editor.action.removeCommentLine",
                                         "when": "editorTextFocus && !editorReadonly" },
    ...
    { "key": "cmd+r f12",             "command": "editor.action.revealDefinitionAside",
                                         "when": "editorHasDefinitionProvider && editorTextFocus && !isInEmbeddedEditor" },
    { "key": "cmd+r cmd+f12",         "command": "editor.action.revealDefinitionAside",
    ...
    { "key": "escape",                "command": "editor.action.selectEditor",
                                         "when": "stickyScrollFocused" },
    { "key": "cmd+r cmd+k",           "command": "editor.action.selectFromAnchorToCursor",
                                         "when": "editorTextFocus && selectionAnchorSet" },
    ...
    { "key": "up",                    "command": "editor.action.selectPreviousStickyScrollLine",
                                         "when": "stickyScrollFocused" },
    { "key": "cmd+r cmd+b",           "command": "editor.action.setSelectionAnchor",
                                         "when": "editorTextFocus" },
    { "key": "shift+f10",             "command": "editor.action.showContextMenu",
                                         "when": "textInputFocus" },
    { "key": "cmd+r cmd+i",           "command": "editor.action.showHover",
                                         "when": "editorTextFocus" },
    ...
    { "key": "ctrl+space",            "command": "editor.action.triggerSuggest",
                                         "when": "editorHasCompletionItemProvider && textInputFocus && !editorReadonly && !suggestWidgetVisible" },
    { "key": "cmd+r cmd+x",           "command": "editor.action.trimTrailingWhitespace",
                                         "when": "editorTextFocus && !editorReadonly" },
    ...
    { "key": "cmd+r cmd+,",           "command": "editor.createFoldingRangeFromSelection",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "escape",                "command": "editor.debug.action.closeExceptionWidget",
                                         "when": "exceptionWidgetVisible" },
    { "key": "cmd+r cmd+i",           "command": "editor.debug.action.showDebugHover",
    ...
    { "key": "cmd+r cmd+0",           "command": "editor.foldAll",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+/",           "command": "editor.foldAllBlockComments",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+-",           "command": "editor.foldAllExcept",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+8",           "command": "editor.foldAllMarkerRegions",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+1",           "command": "editor.foldLevel1",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+2",           "command": "editor.foldLevel2",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+3",           "command": "editor.foldLevel3",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+4",           "command": "editor.foldLevel4",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+5",           "command": "editor.foldLevel5",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+6",           "command": "editor.foldLevel6",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+7",           "command": "editor.foldLevel7",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+[",           "command": "editor.foldRecursively",
                                         "when": "editorTextFocus && foldingEnabled" },
    ...
    { "key": "escape",                "command": "editor.hidePasteWidget",
                                         "when": "pasteWidgetVisible" },
    { "key": "cmd+r cmd+.",           "command": "editor.removeManualFoldingRanges",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+l",           "command": "editor.toggleFold",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r shift+cmd+l",     "command": "editor.toggleFoldRecursively",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "alt+cmd+]",             "command": "editor.unfold",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+j",           "command": "editor.unfoldAll",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+=",           "command": "editor.unfoldAllExcept",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+9",           "command": "editor.unfoldAllMarkerRegions",
                                         "when": "editorTextFocus && foldingEnabled" },
    { "key": "cmd+r cmd+]",           "command": "editor.unfoldRecursively",
                                         "when": "editorTextFocus && foldingEnabled" },
    ...
    { "key": "cmd+r f2",              "command": "togglePeekWidgetFocus",
                                         "when": "inReferenceSearchEditor || referenceSearchVisible" },
    ...
    { "key": "alt+cmd+c",             "command": "copyFilePath",
                                         "when": "!editorFocus" },
    { "key": "cmd+r alt+cmd+c",       "command": "copyFilePath",
                                         "when": "editorFocus" },
    { "key": "shift+alt+cmd+c",       "command": "copyRelativeFilePath",
                                         "when": "!editorFocus" },
    { "key": "cmd+r shift+alt+cmd+c", "command": "copyRelativeFilePath",
                                         "when": "editorFocus" },
    ...
    { "key": "alt+cmd+pageup",        "command": "editor.action.accessibleViewPreviousCodeBlock",
                                         "when": "accessibleViewContainsCodeBlocks && accessibleViewCurrentProviderId == 'panelChat'" },
    { "key": "cmd+r cmd+k",           "command": "editor.action.defineKeybinding",
    ...
    { "key": "cmd+r",                 "command": "inlineChat.regenerate",
                                         "when": "inlineChatHasProvider && inlineChatVisible" },
    { "key": "cmd+r i",               "command": "inlineChat.start",
    ...
    { "key": "cmd+r cmd+a",           "command": "keybindings.editor.addKeybinding",
    ...
    { "key": "enter",                 "command": "keybindings.editor.defineKeybinding",
                                         "when": "inKeybindings && keybindingFocus && !whenFocus" },
    { "key": "cmd+r cmd+e",           "command": "keybindings.editor.defineWhenExpression",
                                         "when": "inKeybindings && keybindingFocus" },
    ...
    { "key": "cmd+a",                 "command": "list.selectAll",
                                         "when": "listFocus && listSupportsMultiselect && !inputFocus && !treestickyScrollFocused" },
    { "key": "cmd+r cmd+i",           "command": "list.showHover",
                                         "when": "listFocus && !inputFocus && !treestickyScrollFocused" },
    ...
    { "key": "cmd+up",                "command": "notebook.cell.chat.focusPreviousCell",
                                         "when": "inlineChatFocused && notebookCellChatFocused" },
    { "key": "cmd+r i",               "command": "notebook.cell.chat.start",
    ...
    { "key": "cmd+r cmd+c",           "command": "notebook.cell.collapseCellInput",
                                         "when": "notebookCellListFocused && !inputFocus && !notebookCellInputIsCollapsed" },
    { "key": "cmd+r t",               "command": "notebook.cell.collapseCellOutput",
    ...
    { "key": "cmd+r cmd+c",           "command": "notebook.cell.expandCellInput",
                                         "when": "notebookCellInputIsCollapsed && notebookCellListFocused" },
    { "key": "cmd+r t",               "command": "notebook.cell.expandCellOutput",
    ...
    { "key": "cmd+r shift+cmd+\\",    "command": "notebook.cell.split",
                                         "when": "editorTextFocus && notebookCellEditable && notebookEditable && notebookEditorFocused" },
    { "key": "cmd+r y",               "command": "notebook.cell.toggleOutputScrolling",
    ...
    { "key": "cmd+r f",               "command": "workbench.action.closeFolder",
    ...
    { "key": "cmd+r shift+o",         "command": "workbench.action.compareEditor.openSide",
                                         "when": "inDiffEditor" },
    { "key": "shift+alt+f5",          "command": "workbench.action.compareEditor.previousChange",
                                         "when": "textCompareEditorVisible" },
    { "key": "cmd+r o",               "command": "workbench.action.copyEditorToNewWindow",
                                         "when": "activeEditor" },
    ...
    { "key": "pageup",                "command": "workbench.action.interactivePlayground.pageUp",
                                         "when": "interactivePlaygroundFocus && !editorTextFocus" },
    { "key": "cmd+r shift+cmd+\\",    "command": "workbench.action.joinEditorInGroup",
                                         "when": "sideBySideEditorActive" },
    { "key": "cmd+r enter",           "command": "workbench.action.keepEditor" },
    { "key": "cmd+r",                 "command": "workbench.action.keychord.leader",
                                         "when": "false" },
    ...
    { "key": "cmd+r right",           "command": "workbench.action.moveActiveEditorGroupRight" },
    { "key": "cmd+r up",              "command": "workbench.action.moveActiveEditorGroupUp" },
    { "key": "cmd+r shift+cmd+left",  "command": "workbench.action.moveEditorLeftInGroup" },
    { "key": "cmd+r shift+cmd+right", "command": "workbench.action.moveEditorRightInGroup" },
    ...
    { "key": "cmd+r shift+enter",     "command": "workbench.action.pinEditor",
                                         "when": "!activeEditorIsPinned" },
    { "key": "shift+cmd+[",           "command": "workbench.action.previousEditor" },
    { "key": "alt+cmd+left",          "command": "workbench.action.previousEditor" },
    { "key": "cmd+r alt+cmd+left",    "command": "workbench.action.previousEditorInGroup" },
    ...
    { "key": "cmd+r shift+cmd+\\",    "command": "workbench.action.splitEditorInGroup",
    ...
    { "key": "cmd+f",                 "command": "workbench.action.terminal.focusFind",
                                         "when": "terminalFindFocused && terminalHasBeenCreated || terminalFindFocused && terminalProcessSupported || terminalFocusInAny && terminalHasBeenCreated || terminalFocusInAny && terminalProcessSupported" },
    { "key": "cmd+r cmd+i",           "command": "workbench.action.terminal.focusHover",
    ...
    { "key": "ctrl+cmd+f",            "command": "workbench.action.toggleFullScreen",
                                         "when": "!isIOS" },
    { "key": "cmd+r cmd+m",           "command": "workbench.action.toggleMaximizeEditorGroup",
    ...
    { "key": "cmd+r shift+enter",     "command": "workbench.action.unpinEditor",
                                         "when": "activeEditorIsPinned" },
    ...
    { "key": "left",                  "command": "workbench.banner.focusPreviousAction",
                                         "when": "bannerFocused" },
    { "key": "shift+alt+cmd+y",       "command": "workbench.debug.action.toggleRepl",
    ...
    { "key": "cmd+r e",               "command": "workbench.files.action.focusOpenEditorsView",
    ...
    { "key": "ctrl+pageup",           "command": "notebook.focusPreviousEditor",
                                         "when": "accessibilityModeEnabled && notebookCellEditorFocused" },
    { "key": "cmd+r down",            "command": "views.moveViewDown",
                                         "when": "focusedView != ''" },
    { "key": "cmd+r left",            "command": "views.moveViewLeft",
                                         "when": "focusedView != ''" },
    { "key": "cmd+r right",           "command": "views.moveViewRight",
                                         "when": "focusedView != ''" },
    { "key": "cmd+r up",              "command": "views.moveViewUp",
                                         "when": "focusedView != ''" },
    ...
    { "key": "ctrl+p",                "command": "workbench.action.quickOpenSelectPrevious",
                                         "when": "inQuickOpen" },
    { "key": "shift+cmd+r",           "command": "workbench.action.reloadWindow",
                                         "when": "isDevelopment" },
    ...
    { "key": "shift+cmd+j",           "command": "aiSettings.action.open",
                                         "when": "!isSettingsPaneOpen" },
    ...
    { "key": "shift+alt+u",           "command": "java.projectConfiguration.update",
                                         "when": "editorFocus" },
    { "key": "alt+cmd+r",             "command": "java.view.package.revealFileInOS",
    ...
    { "key": "cmd+k q",               "command": "quokka.makeQuokkaFromExistingFile",
                                         "when": "!quokka.isLiveShareClient && !terminalFocus" },
    { "key": "shift+cmd+r",           "command": "reactSnippets.search",
                                         "when": "editorTextFocus" },
    ...
    { "key": "alt+cmd+c",             "command": "java.view.package.copyFilePath",
                                         "when": "focusedView == 'javaProjectExplorer' && java:serverMode == 'Standard'" },
    ...
    { "key": "cmd+k j",               "command": "quokka.createJavaScriptFile",
                                         "when": "!quokka.isLiveShareClient && !terminalFocus" },
    { "key": "alt+[",                 "command": "github.copilot.previousPanelSolution",
                                         "when": "github.copilot.activated && github.copilot.panelVisible && activeWebviewPanelId == 'GitHub Copilot Suggestions'" },
    { "key": "shift+cmd+v",           "command": "java.action.clipboardPasteAction",
                                         "when": "javaLSReady && editorLangId == 'java'" },
    { "key": "shift+alt+cmd+c",       "command": "java.view.package.copyRelativeFilePath",
                                         "when": "focusedView == 'javaProjectExplorer' && java:serverMode == 'Standard'" },
    { "key": "ctrl+enter",            "command": "jupyter.runcurrentcell",
                                         "when": "editorTextFocus && isWorkspaceTrusted && jupyter.hascodecells && !editorHasSelection && !jupyter.havenativecells && !notebookEditorFocused" },
    { "key": "enter",                 "command": "python.execInREPLEnter",
                                         "when": "!config.interactiveWindow.executeWithShiftEnter && activeEditor == 'workbench.editor.interactive'" },
    { "key": "cmd+k t",               "command": "quokka.createTypeScriptFile",
                                         "when": "!quokka.isLiveShareClient && !terminalFocus" },
    { "key": "alt+]",                 "command": "github.copilot.nextPanelSolution",
                                         "when": "github.copilot.activated && github.copilot.panelVisible && activeWebviewPanelId == 'GitHub Copilot Suggestions'" },
    { "key": "shift+cmd+v",           "command": "java.action.filesExplorerPasteAction",
                                         "when": "config.editor.pasteAs.enabled && explorerViewletFocus" },
    { "key": "enter",                 "command": "java.view.package.renameFile",
                                         "when": "focusedView == 'javaProjectExplorer' && java:serverMode == 'Standard'" },
    ...
    { "key": "cmd+k l",               "command": "quokka.createFile",
                                         "when": "!quokka.isLiveShareClient && !terminalFocus" },
    ...
    { "key": "ctrl+shift+alt+s",      "command": "java.action.doCleanup",
                                         "when": "javaLSReady && editorLangId == 'java'" },
    { "key": "cmd+backspace",         "command": "java.view.package.moveFileToTrash",
                                         "when": "explorerResourceMoveableToTrash && focusedView == 'javaProjectExplorer' && java:serverMode == 'Standard'" },
    { "key": "cmd+k s",               "command": "quokka.stopCurrent",
                                         "when": "quokka.hasActiveSession && !quokka.isLiveShareClient && !terminalFocus" },
    { "key": "cmd+backspace",         "command": "java.view.package.deleteFilePermanently",
                                         "when": "!explorerResourceMoveableToTrash && focusedView == 'javaProjectExplorer' && java:serverMode == 'Standard'" },
    ...
    { "key": "cmd+k v",               "command": "quokka.showValue",
    ...
    { "key": "ctrl+; x",              "command": "jupyter.deleteCells",
                                         "when": "editorTextFocus && jupyter.hascodecells && !jupyter.webExtension && !notebookEditorFocused" },
    { "key": "cmd+k x",               "command": "quokka.copyValue",
                                         "when": "quokka.hasActiveSession && quokka.isActiveEditorRunningQuokka && !quokka.isLiveShareClient && !terminalFocus" },
    { "key": "cmd+backspace",         "command": "aichat.cancelchat",
    ...
    { "key": "ctrl+shift+tab",        "command": "aichat.selectNextTab",
                                         "when": "view == 'workbench.panel.aichat.view'" },
    { "key": "ctrl+tab",              "command": "aichat.selectPreviousTab",
                                         "when": "view == 'workbench.panel.aichat.view'" },
    { "key": "alt+d",                 "command": "aidebug.autodebugterminal",
                                         "when": "terminalFocus" },
    { "key": "cmd+.",                 "command": "cursor.aichat.toggleChatMode",
                                         "when": "(arbitrary function) && (arbitrary function)" },
    { "key": "cmd+enter",             "command": "cursorai.action.executeInterpreterAction",
                                         "when": "(arbitrary function)" },
    { "key": "cmd+u",                 "command": "cursorai.action.retryInterpreterAction",
    ...
    { "key": "ctrl+shift+alt+[",      "command": "jupyter.extendSelectionByCellAbove",
                                         "when": "editorTextFocus && jupyter.hascodecells && !jupyter.webExtension && !notebookEditorFocused" },
    { "key": "cmd+k i",               "command": "quokka.installMissingPackageToQuokka",
                                         "when": "quokka.hasActiveSession && !quokka.isLiveShareClient && !terminalFocus" },
    ...
    { "key": "cmd+enter",             "command": "editor.action.inlineDiffs.acceptAll",
                                         "when": "editorTextFocus && (arbitrary function)" },
    { "key": "cmd+pausebreak",        "command": "editor.action.inlineDiffs.acceptAllAcrossAllEditors",
                                         "when": "editorHasPromptBar && editorTextFocus || editorTextFocus && hasDisplayedDiff" },
    { "key": "cmd+y",                 "command": "editor.action.inlineDiffs.acceptPartialEdit",
                                         "when": "editorTextFocus && (arbitrary function)" },
    { "key": "cmd+backspace",         "command": "editor.action.inlineDiffs.rejectAll",
                                         "when": "editorTextFocus && (arbitrary function)" },
    { "key": "cmd+ctrl",              "command": "editor.action.inlineDiffs.rejectAllAcrossAllEditors",
                                         "when": "editorHasPromptBar && editorTextFocus || editorTextFocus && hasDisplayedDiff" },
    { "key": "cmd+ctrl",              "command": "editor.action.inlineDiffs.rejectAllAcrossAllEditors",
                                         "when": "editorHasPromptBar && editorTextFocus || editorTextFocus && hasDisplayedDiff" },
    { "key": "cmd+n",                 "command": "editor.action.inlineDiffs.rejectPartialEdit",
                                         "when": "editorTextFocus && (arbitrary function)" },
    { "key": "cmd+i",                 "command": "composer.startComposerPrompt",
                                         "when": "composerIsEnabled" },
    { "key": "cmd+backspace",         "command": "editor.action.inlineDiffs.cancelEdits",
    ...
    { "key": "cmd+backspace",         "command": "editor.action.cancelGPT4WithCmdDelete",
                                         "when": "hadGPT4InlineCompletionRunning" },
    { "key": "cmd+n",                 "command": "editor.action.rejectGPT4",
                                         "when": "editorTextFocus && hasGPT4Diff" },
    { "key": "cmd+g",                 "command": "editor.action.simpleInlineDiffs.acceptAll",
                                         "when": "editorTextFocus && hasDisplayedSimpleDiff" },
    { "key": "cmd+h",                 "command": "editor.action.simpleInlineDiffs.rejectAll",
                                         "when": "editorTextFocus && hasDisplayedSimpleDiff" },
    ...
    { "key": "cmd+enter",             "command": "cursorai.action.acceptGenerateInTerminal",
                                         "when": "terminalFocus && terminalHasBeenCreated || terminalProcessSupported && (arbitrary function)" },
    { "key": "cmd+backspace",         "command": "cursorai.action.cancelGenerateInTerminal",
                                         "when": "terminalFocus && terminalHasBeenCreated || terminalProcessSupported && (arbitrary function)" },
    { "key": "cmd+k",                 "command": "cursorai.action.generateInTerminal",
                                         "when": "terminalFocus && terminalHasBeenCreated || terminalFocus && terminalProcessSupported" },
    { "key": "escape",                "command": "cursorai.action.hideGenerateInTerminal",
                                         "when": "terminalFocus && terminalHasBeenCreated || terminalProcessSupported && (arbitrary function)" },
    { "key": "cmd+enter",             "command": "cursorai.action.acceptAndRunGenerateInTerminal",
                                         "when": "terminalFocus && terminalHasBeenCreated || terminalProcessSupported && (arbitrary function)" },
    { "key": "cmd+backspace",         "command": "cursorai.action.rejectGenerateInTerminal",
                                         "when": "terminalFocus && terminalHasBeenCreated || terminalProcessSupported && (arbitrary function)" },
    { "key": "shift+cmd+e",           "command": "aichat.fixerrormessage",
                                         "when": "(arbitrary function)" },
...
export const vsCodeShortchutMac = [
    { "key": "shift+meta+P, F1",          "command": "workbench.action.showCommandPalette" },
    { "key": "meta + P",               "command": "workbench.action.quickOpen" },
    { "key": "shift+meta+N",              "command": "workbench.action.newWindow" },
    { "key": "meta+W",               "command": "workbench.action.closeWindow" },
    ...
    { "key": "alt+arrowdown / alt+arrowup",          "command": "editor.action.moveLinesDownAction" },
    { "key": "shift+alt+arrowdown / shift+alt+arrowup",        "command": "editor.action.copyLinesDownAction" },
    { "key": "shift+meta+K",              "command": "editor.action.deleteLines" },
    { "key": "meta+Enter / shift+meta+Enter", "command": "editor.action.insertLineAfter" },
    { "key": "shift+meta+\\",             "command": "editor.action.jumpToBracket" },
    { "key": "meta+] / meta+[",          "command": "editor.action.indentLines" },
    { "key": "Home / End",       "command": "cursorHome" },
    { "key": "meta+arrowup / meta+arrowdown",          "command": "cursorTop" },
    { "key": "⌃PgUp / ⌃PgDn",    "command": "scrollLineUp" },
    { "key": "meta+PgUp /meta+PgDn",     "command": "scrollPageUp" },
    { "key": "alt+meta+[ / alt+meta+]",        "command": "editor.fold" },
    { "key": "meta+K meta+[ / meta+K meta+]",    "command": "editor.foldAll" },
    { "key": "meta+K meta+0 / meta+K meta+J",    "command": "editor.foldAllSubregions" },
    ...
    { "key": "shift+alt+A",              "command": "editor.action.blockComment" },
    { "key": "alt+Z",               "command": "toggleWordWrap" },
    { "key": "alt+ + click",        "command": "editor.action.addCursor" },
    { "key": "alt+meta+arrowup",              "command": "editor.action.insertCursorAbove" },
    { "key": "alt+meta+arrowdown",              "command": "editor.action.insertCursorBelow" },
    { "key": "meta+U",               "command": "editor.action.undoCursorPosition" },
    { "key": "shift+alt+I",              "command": "editor.action.insertCursorAtEndOfSelection" },
    { "key": "meta+L",               "command": "editor.action.selectCurrentLine" },
    { "key": "shift+meta+L",              "command": "editor.action.selectHighlights" },
    { "key": "meta+F2",              "command": "editor.action.selectHighlights" },
    { "key": "⌃shift+meta+→ / ←",         "command": "editor.action.smartSelect.expand" },
    { "key": "shift+alt+ + drag",        "command": "editor.action.columnSelect" },
    { "key": "meta+F",               "command": "actions.find" },
    { "key": "alt+meta+F",              "command": "actions.findWithReplace" },
    { "key": "meta+G / shift+meta+G",         "command": "editor.action.nextMatchFindAction" },
    { "key": "alt+Enter",           "command": "editor.action.selectAllMatches" },
    ...
    { "key": "⌃Space, meta+I",       "command": "editor.action.triggerSuggest" },
    { "key": "shift+meta+Space",          "command": "editor.action.triggerParameterHints" },
    { "key": "shift+alt+F",              "command": "editor.action.formatDocument" },
    { "key": "meta+K meta+F",           "command": "editor.action.formatSelection" },
    { "key": "F12",              "command": "editor.action.goToDeclaration" },
    { "key": "alt+F12",             "command": "editor.action.peekDefinition" },
    { "key": "meta+K F12",           "command": "editor.action.openDefinitionToSide" },
    { "key": "meta+.",               "command": "editor.action.quickFix" },
    { "key": "shift+F12",             "command": "editor.action.showReferences" },
    { "key": "F2",               "command": "editor.action.rename" },
    ...
    { "key": "⌃G",               "command": "workbench.action.gotoLine" },
    { "key": "shift+meta+O",              "command": "workbench.action.gotoSymbol" },
    { "key": "shift+meta+M",              "command": "workbench.actions.view.problems" },
    { "key": "F8 / shift+F8",         "command": "editor.action.marker.next" },
    { "key": "⌃shift+Tab",            "command": "workbench.action.navigateEditorGroups" },
    { "key": "⌃- / ⌃shift+-",         "command": "workbench.action.navigateBack" },
    ...
    { "key": "meta+1 / meta+2 / meta+3",     "command": "workbench.action.focusFirstEditorGroup" },
    { "key": "meta+N",               "command": "workbench.action.files.newUntitledFile" },
    { "key": "meta+S",               "command": "workbench.action.files.save" },
    { "key": "meta+W",               "command": "workbench.action.files.close" },
    { "key": "meta+K W",             "command": "workbench.action.closeAllEditors" },
    { "key": "shift+meta+T",              "command": "workbench.action.reopenClosedEditor" },
    { "key": "⌃Tab",             "command": "workbench.action.openNextRecentlyUsedEditorInGroup" },
    { "key": "meta+K R",             "command": "workbench.action.files.revealActiveFileInMacOSFinder" },
    { "key": "meta+K O",             "command": "workbench.action.files.openInNewWindow" },
    { "key": "⌃meta+F",              "command": "workbench.action.toggleFullScreen" },
    { "key": "meta+= / shift+meta+-",         "command": "workbench.action.zoomIn" },
    { "key": "meta+B",               "command": "workbench.action.toggleSidebarVisibility" },
    { "key": "shift+meta+E",              "command": "workbench.view.explorer" },
    { "key": "shift+meta+F",              "command": "workbench.view.search" },
    { "key": "⌃shift+G",              "command": "workbench.view.scm" },
    ...
    { "key": "F9",               "command": "editor.debug.action.toggleBreakpoint" },
    { "key": "F5",               "command": "workbench.action.debug.continue" },
    { "key": "F11 / shift+F11",       "command": "workbench.action.debug.stepInto" },
    { "key": "meta+C",               "command": "editor.action.clipboardCopyAction" },
]
...
export const macOsShortcut = [
        ...
        { "key": "meta + `", "command": "switch between windows" },
        ...
        { "key": "meta + /", "command": "toggle Finder status bar" },
        ...
        { "key": "meta + [", "command": "go back in Finder" },
        { "key": "meta + ]", "command": "go forward in Finder" },
